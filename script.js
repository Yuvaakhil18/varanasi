...
const TRAILER_URL = 'https://youtu.be/DMD2uthghWE?si=tegYL49UxPIKRVXL';
...
(function () {
    ...
    const visibleDuration = 6000; // ms each slide stays visible (excluding transition)
    const transitionDuration = 1200; // should match CSS transition (ms)
